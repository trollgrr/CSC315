 ...
 * @author benupton
 */
public class FlightHandlerInit extends javax.swing.JFrame {

    /**
     * Creates new form FlightHandlerInit
     */
    public FlightHandlerInit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("tab1", initButton);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FlightHandlerInit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FlightHandlerInit().setVisible(true);
            }
        });
    }
